...
function renderTable() {
    ...
    tbody.innerHTML = slice.length ? slice.map(function (m, i) { return `
        <tr>
            ...
            <td><span style="font-weight:700;color:#1e293b;">${m.moduleName}</span></td>
        ...
        </tr>`; }).join('') : '<tr><td colspan="5" class="text-center py-4 text-muted">No modules found</td></tr>';
...
function saveModule() {
    ...
    var body = { moduleName: moduleName, displayOrder: displayOrder, isActive: isActive };
