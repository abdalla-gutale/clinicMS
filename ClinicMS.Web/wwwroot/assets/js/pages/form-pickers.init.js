...
var classicPickrPortal = document.querySelectorAll(".classic-colorpicker");
if (classicPickrPortal)
    Array.from(classicPickrPortal).forEach(function () {
        Pickr.create({
...
// Portal color picker
var PortalColorPickr = document.querySelectorAll(".colorpicker-Portal");
if (PortalColorPickr)
    Array.from(PortalColorPickr).forEach(function () {
        Pickr.create({
            el: ".colorpicker-Portal",
            theme: "monolith",
            default: "#405189",
            components: {
                // Main components
